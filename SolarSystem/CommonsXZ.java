...
public class CommonsXZ extends JPanel {
    ...
    public CommonsXZ(BranchGroup sceneBG) {
    ...
    public static void main(String[] args) {
        frame = new JFrame("XZ's Common File");            // NOTE: change XY to student's initials
        frame.getContentPane().add(new CommonsXZ(create_Scene()));  // create an instance of the class
